...
const ini =
  ...
  `; DO NOT EDIT -- regenerated by \`npm run build:spicetify\`, which is a\n` +
  `; manual target: NOT part of \`npm run build\`, so this file can lag the\n` +
  `; active theme. It also claims current_theme, overriding Marketplace.\n` +
